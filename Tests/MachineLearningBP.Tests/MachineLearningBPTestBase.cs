...
namespace MachineLearningBP.Tests
{
    public abstract class MachineLearningBPTestBase : AbpIntegratedTestBase<MachineLearningBPTestModule>
    {
        ...
        protected void UsingDbContext(Action<MachineLearningBPDbContext> action)
        {
            UsingDbContext(AbpSession.TenantId, action);
        }

        protected Task UsingDbContextAsync(Func<MachineLearningBPDbContext, Task> action)
        {
            return UsingDbContextAsync(AbpSession.TenantId, action);
        }

        protected T UsingDbContext<T>(Func<MachineLearningBPDbContext, T> func)
        {
            return UsingDbContext(AbpSession.TenantId, func);
        }

        protected Task<T> UsingDbContextAsync<T>(Func<MachineLearningBPDbContext, Task<T>> func)
        {
            return UsingDbContextAsync(AbpSession.TenantId, func);
        }

        protected void UsingDbContext(int? tenantId, Action<MachineLearningBPDbContext> action)
        {
            using (UsingTenantId(tenantId))
            {
                using (var context = LocalIocManager.Resolve<MachineLearningBPDbContext>())
                {
        ...
        protected async Task UsingDbContextAsync(int? tenantId, Func<MachineLearningBPDbContext, Task> action)
        {
            using (UsingTenantId(tenantId))
            {
                using (var context = LocalIocManager.Resolve<MachineLearningBPDbContext>())
        ...
        protected T UsingDbContext<T>(int? tenantId, Func<MachineLearningBPDbContext, T> func)
        {
            T result;
        ...
        protected async Task<T> UsingDbContextAsync<T>(int? tenantId, Func<MachineLearningBPDbContext, Task<T>> func)
        {
            T result;
