...
using Abp.Hangfire;
using Abp.Owin;
using MachineLearningBP.Api.Controllers;
using MachineLearningBP.Web;
using Hangfire;
...
namespace MachineLearningBP.Web
{
    public class Startup
    {
        public void Configuration(IAppBuilder app)
        {
            ...
            //ENABLE TO USE HANGFIRE dashboard (Requires enabling Hangfire in MachineLearningBPWebModule)
