...
{
    public class MediumExampleDomainService<TSample, TStatLine, TExample, TExampleGenerationInfo, TTimeGrouping> : MinimumExampleDomainService<TSample, TStatLine, TExample, TExampleGenerationInfo>
